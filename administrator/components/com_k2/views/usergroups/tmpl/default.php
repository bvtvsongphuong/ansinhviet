<?php
/**
 * @version		$Id: default.php 486 2010-06-17 12:34:48Z lefteris.kavadas $
 * @package		K2
  ...
  <table class="adminlist">
    <thead>
      <tr>
        ...
        <th><?php echo JHTML::_('grid.sort', JText::_('User count'), 'numOfUsers', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
