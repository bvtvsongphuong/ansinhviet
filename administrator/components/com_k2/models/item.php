<?php
/**
 * @version		$Id: item.php 498 2010-06-23 14:31:48Z joomlaworks $
 * @package		K2
...
class K2ModelItem extends JModel {
    ...
    function checkSIG() {
        ...
        if (JFile::exists(JPATH_PLUGINS.DS.'content'.DS.'jw_sigpro.php') || JFile::exists(JPATH_PLUGINS.DS.'content'.DS.'jw_sig.php')) {
            ...
            //$mainframe->enqueueMessage(JText::_('Notice: Please install the Simple Image Gallery Pro plugin if you want to use the image gallery features of K2!'), 'notice');
            return false;
        }
    }
